...
# Bot images & videos
PICS = (environ.get('PICS', 'https://graph.org/file/42e20d1a6e4fa288e1fb2.jpg')).split()
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <em>File Name</em>: <code>ABHI|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> \n\n❤️‍🔥 </i>Join</i> [𝐌𝐨𝐯𝐢𝐞 𝐁𝐲 𝐀𝐛𝐡𝐢™](https://t.me/moviebyabhi29)  \n\n🖥 <i>Requests</i> - ||@Bishnoi_Hub|| ')
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", '')
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", '🏷 𝖳𝗂𝗍𝗅𝖾: <a href={url}>{title}</a> \n🔮 𝖸𝖾𝖺𝗋: {year} \n⭐️ 𝖱𝖺𝗍𝗂𝗇𝗀𝗌: {rating}/ 10  \n🎭 𝖦𝖾𝗇𝖾𝗋𝗌: {genres} \n\n🎊 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 [『Aʙʜɪ』](t.me/Bishnoi_botz)')
